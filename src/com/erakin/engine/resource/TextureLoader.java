...
import static com.erakin.engine.Maths.fold;
...
import com.erakin.engine.lwjgl.GLUtil;
import com.erakin.engine.resource.textures.TextureData;
import com.erakin.engine.resource.textures.TextureReaderFactory;
import com.erakin.engine.resource.textures.TextureReader;
import com.erakin.engine.resource.textures.TextureException;
import com.erakin.engine.resource.textures.TextureRuntimeException;
...
public final class TextureLoader extends DefaultLoader
{
	 ...
	 */
	private static final int MAX_TEXTURE_SIZE = GLUtil.glMaxTextureSize();
